...
export const cards: Card[] = [
  ...
  {
    id: "broken_equipment",
    icon: `<svg viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="16.5" y="222.481" width="267" height="41.755" rx="20.877" stroke="currentColor" stroke-width="15"/><circle cx="262.623" cy="243.358" r="8.868" fill="currentColor"/><circle cx="85.264" cy="243.358" r="8.868" fill="currentColor"/><circle cx="129.604" cy="243.358" r="8.868" fill="currentColor"/><circle cx="173.943" cy="243.358" r="8.868" fill="currentColor"/><circle cx="218.283" cy="243.358" r="8.868" fill="currentColor"/><circle cx="40.925" cy="243.358" r="8.868" fill="currentColor"/><path d="M224.786 187.343 79.056 41.539l-9.459 9.386 21.284 21.209-12.268 21.135a3.643 3.643 0 0 0 .887 4.73l15.593 12.045c-.296 2.513-.517 4.951-.517 7.39s.221 4.803.517 7.168L79.5 136.869a3.644 3.644 0 0 0-.887 4.73l14.78 25.569c.887 1.626 2.882 2.217 4.508 1.626l18.401-7.464c3.843 2.956 7.833 5.469 12.489 7.316l2.734 19.584c.296 1.773 1.848 3.103 3.695 3.103h29.56c1.847 0 3.399-1.33 3.695-3.103l2.734-19.584c3.769-1.552 7.095-3.547 10.272-5.838l33.92 33.92 9.385-9.385ZM150 143.299c-14.263 0-25.865-11.602-25.865-25.865 0-3.695.887-6.799 2.143-9.829l33.551 33.551c-3.03 1.33-6.134 2.143-9.829 2.143Zm-1.921-51.508-23.5-23.5c1.404-.74 2.734-1.478 4.212-2.07l2.734-19.583a3.737 3.737 0 0 1 3.695-3.103h29.56a3.737 3.737 0 0 1 3.695 3.103l2.734 19.584c4.656 1.847 8.646 4.36 12.489 7.242l18.401-7.39c1.626-.665 3.621 0 4.508 1.626l14.78 25.569c.887 1.626.517 3.62-.887 4.73l-15.593 12.045c.296 2.513.518 4.951.518 7.39s-.222 4.803-.518 7.168l15.593 12.267c1.404 1.109 1.774 3.104.887 4.73l-8.572 14.928-37.172-37.172c.222-.591.222-1.256.222-1.921 0-14.263-11.602-25.865-25.865-25.865-.665 0-1.256 0-1.921.222Z" fill="currentColor"/></svg>`,
    title: {
      en: "Equipment broken",
      fi: "Laiteongelma",
    },
